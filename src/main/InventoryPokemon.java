...
public class InventoryPokemon extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("PokeVentory, the Pokemon's Inventory");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InventoryPokemon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InventoryPokemon dialog = new InventoryPokemon(new javax.swing.JFrame(), true);
